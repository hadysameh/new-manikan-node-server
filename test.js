a = {
  ...
  LeftArm: [
    {
      ...
      axisName: 'X',
      customAxisName: 'custom_z_axis_local',
      calibrationVolt: 319,
      voltSign: 1,
    },
    {
      ...
      bodyBoneName: 'LeftArm',
      axisName: 'Y',
      customAxisName: 'custom_x_axis_local',
      calibrationVolt: 1016,
      voltSign: 1,
    },
    {
      armatureBoneName: 'Ctrl_Arm_FK_Left',
  ...
  bonesCustomAxesMappings: {
    'LeftArm.X': 'custom_z_axis_local',
    'LeftArm.Y': 'custom_x_axis_local',
    'LeftUpLeg.X': 'custom_x_axis_local',
    'LeftUpLeg.Y': 'custom_z_axis_local',
    'RightUpLeg.X': 'custom_x_axis_local',
    'RightUpLeg.Y': 'custom_z_axis_local',
    'RightArm.X': 'custom_z_axis_local',
    'RightArm.Y': 'custom_x_axis_local',
  },
};
